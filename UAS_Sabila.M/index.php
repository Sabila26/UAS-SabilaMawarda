...
<body class="home">
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo1.png" alt="" width="6%"> </a>
    ...
    <section class="hero bg-image" data-image-src="images/img/bg1.webp">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>KOALA Catering, Cake, & Bakery</h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Pilih Pesanan</h4>
                    </div>
                    <!--  Author Name: MH RONY.
                        GigHub Link: https://github.com/dev-mhrony
                        Facebook Link:https://www.facebook.com/dev.mhrony
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Order Pesanan</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Delivery / Ambil Ditempat</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Produk Terpopuler dan Terfavorit</h2>
                <p class="lead">Cara mudah memesan produk favoritmu</p>
            </div>
            <div class="row">
                <!--  Author Name: MH RONY.
                        GigHub Link: https://github.com/dev-mhrony
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Pilih Pesanan</h3>
                                <p>Kami menyediakan beberapa pilihan menu secara online.</p>
                            </div>
                        </div>
                    </div>
                    <!--  Author Name: MH RONY.
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Order Pesanan</h3>
                            <p>Kami menyediakan pemesanan secara online.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3>Delivery / ambil ditempat</h3>
                            <p>Pengantaran produk secara COD / dapat diambil sendiri. </p>
                        </div>
                    </div>
                </div>
            </div>
